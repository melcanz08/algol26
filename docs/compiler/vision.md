...
4. **Not a manual-memory-by-default systems language**
   - Safe memory by default (no manual allocation)
   - Supports controlled systems programming via regions and unsafe
