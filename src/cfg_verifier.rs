...
impl SemanticCFGVerifier {
    pub fn verify(func: &crate::semantic_ir::SemanticFunction) -> Result<(), String> {
        use std::collections::HashSet;
        use crate::semantic_ir::SemanticInstruction;
    ...
    pub fn verify_program(program: &crate::semantic_ir::SemanticProgram) -> Result<(), String> {
    ...
    pub fn assert_valid(program: &crate::semantic_ir::SemanticProgram) {
...
mod tests {
    use super::*;
    use crate::semantic_ir::{SemanticProgram, SemanticFunction, SemanticBlock, SemanticInstruction, TypedIRValue};
    ...
    fn test_duplicate_block_id() {
        let func = SemanticFunction {
            ...
            blocks: vec![
                SemanticBlock { id: 0, instructions: vec![SemanticInstruction::Return { value: None, type_: SemanticType::Void }] },
        ...
        let func = SemanticFunction {
            ...
            blocks: vec![
                SemanticBlock {
                    id: 0,
                    instructions: vec![
                        SemanticInstruction::Return { value: None, type_: SemanticType::Void },
