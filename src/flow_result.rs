...
// Coercion helper
impl crate::semantic_type::SemanticType {
    pub fn can_coerce_to(&self, target: &crate::semantic_type::SemanticType) -> bool {
        match (self, target) {
            (crate::semantic_type::SemanticType::Int, crate::semantic_type::SemanticType::Float) => true,
            (crate::semantic_type::SemanticType::Unknown, _) => true,
            (_, crate::semantic_type::SemanticType::Unknown) => true,
            (a, b) => a == b,
        }
    }
}
