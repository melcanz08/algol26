...
use algol26::frontend::ast::{Expr, BinOp};
...
fn test_translate_simple_exprs() {
    ...
    let scopes: Vec<HashMap<String, algol26::semantics::expr_translator::VariableInfo>> = Vec::new();
...
fn test_translate_var_lookup() {
    ...
    let expr = Expr::Var("x".to_string(), (0, 0));
    let result = translator.translate(&expr, &scopes);
...
fn test_translate_function_call() {
    ...
    let expr = Expr::FunctionCall { span: (0, 0),
